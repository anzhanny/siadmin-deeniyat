            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="text-center mt-5">
                        ...
                        <p><strong>Tagihan:</strong> Rp {{ number_format($payment->amount, 0, ',', '.') }}</p>

                        {{-- Snap QRIS --}}
                        <button id="pay-button" class="btn btn-primary">Bayar via QRIS</button>

                        <hr>

                        {{-- Simulasi Bayar --}}
                        <form action="{{ route('student.payment.simulate', $payment->id) }}" method="POST">
                            @csrf
