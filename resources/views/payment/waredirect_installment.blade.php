            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto text-white">
                        ...
                        <h2>Terima kasih!</h2>
                        <p>Pembayaran tunai cicilan Anda akan diproses. Silakan konfirmasi ke admin.</p>

                        <a href="{{ $url }}" target="_blank" class="btn btn-success mt-3">
                            Hubungi Admin via WhatsApp
                        </a>

                        <a href="{{ route('student.payment.history') }}" class="btn btn-lg btn-primary mt-3">
                            <i class="fas fa-home me-2"></i> lihat riwayat pembayaran
                        </a>
                    </div>
                </div>
            </div>
