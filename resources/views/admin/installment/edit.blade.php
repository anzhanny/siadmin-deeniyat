  ...
  <div class="col-12">
    <div class="card mb-4">
      ...
      <div class="card-body px-4 pt-4 pb-2">
        <form action="{{ route('admin.installment.update', $data->id) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="mb-3">
            ...
            <input type="number" name="payment_id" id="payment_id" class="form-control"
              value="{{ $data->payment_id }}" required>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" name="remaining_balance" id="remaining_balance" class="form-control"
              value="{{ $data->remaining_balance }}" required>
          </div>
